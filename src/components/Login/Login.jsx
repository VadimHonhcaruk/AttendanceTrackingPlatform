...
import { loginFunc } from '../../function/login';

export const Login = ({ email, password, setEmail, setPassword, error, setPage }) => {
    return (
        <div className={c.center}>
            <div className={c.login}>
                ...
                <Button tag='Login' onclick={() => { loginFunc(email, password, setPage) }} />
            </div>
        </div>
    )
}
